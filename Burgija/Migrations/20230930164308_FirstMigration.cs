        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartOfDiscount = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndOfDiscount = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tool_Store_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Store",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tool_ToolType_ToolTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tool_StoreId",
                table: "Tool",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_Tool_ToolTypeId",
                table: "Tool",
                column: "ToolTypeId");
        }
